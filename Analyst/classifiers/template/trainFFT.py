...
# if you have >1Gb RAM on your GPU, increase this
batch_size = 4
...
data = datasetFFT.read_train_sets(train_path, classes, validation_size=0.2)

session = tf.Session()
x = tf.placeholder(tf.float32, shape=[None, 500, 128, 1], name='x')
...
def show_progress(epoch, feed_dict_train, feed_dict_validate, val_loss):
    ...
    sendmsg = msg.format(epoch + 1, acc, val_acc, val_loss)
    print(sendmsg)
    sock.sendto(sendmsg, (UDP_IP, UDP_PORT))
