...
void wgt_FFT::Initialize()
{
    ...
    AddGraph(FFT_AVG_GRAPH_NAME,Qt::green);// average power
...
void wgt_FFT::UpdateFFT(FFT_Hist *pFFTHelp)
{
    ...
    float *rowdat = pFFTHelp->GetCacheRow(1);//pFFTHelp->AvgData();// get average data instead of instantaneous
